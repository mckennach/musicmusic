...
const Hero = React.forwardRef<HTMLDivElement, any>(({ className, ...props }, ref) => { 
  return (
...
const HeroImage = React.forwardRef<HTMLSpanElement, HeroImageProps>(({ src, alt, fallback, className, ...props }, ref) => {
  return (
...
const HeroDescription = React.forwardRef<HTMLDivElement, any>(({ html, src, alt, fallback, className, ...props }, ref) => {
  return (
    <div className={cn(className)} ref={ref} {...props} 
...
export { Hero, HeroImage, HeroHeading, HeroTextContainer, HeroDescription }
