...
import { RepeatStateTypes, ShuffleStateTypes } from '@/types/player.types'
...
export const shuffleStateAtom = atomWithStorage<ShuffleStateTypes>(
  'shuffleState',
  false
)

export const repeatStateAtom = atomWithStorage<RepeatStateTypes>(
  'repeatState',
  'off'
)
